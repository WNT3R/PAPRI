...
<?php
                ...
                <div class="form-floating mt-1">
                    <input type="phone" name="phone" value="<?=$user['phone']?>" class="form-control rounded-0" placeholder="phone">
                    <label for="floatingInput">phone number</label>
                </div>
                <?=showError('phone')?>

                <div class="form-floating mt-1">
                    <input type="text"  value="<?=$user['address']?>" name="address" class="form-control rounded-0" placeholder="address">
