  ...
  <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <form method="post" action="assets/php/actions.php?addpost" enctype="multipart/form-data">
                    ...
                    <div class="mb-3">
                        <label for="exampleFormControlTextarea1" class="form-label">Post Event or Products Name</label>
...
<div class="offcanvas offcanvas-start" tabindex="-1" id="map" aria-labelledby="offcanvasExampleLabel">
  <div class="offcanvas-header">
    <h5 class="offcanvas-title" id="offcanvasExampleLabel">Store near me</h5>
  </div>
 <div class="modal-header">
        <iframe src="https://www.google.com/maps/d/embed?mid=1avIli6llVsxmblgMiGdnj45PXdr-FjA&ehbc=2E312F" width="640" height="480"></iframe>
     <button type="button" class="btn-close text-reset" data-bs-dismiss="offcanvas" aria-label="Close"></button>
 </div>
</div>
...
<div class="modal fade" id="chatbox" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable">
    <div class="modal-content">
      ...
      <li><a href="assets/pages/schedule/index.php"> <i class="bi bi-calendar-plus"></i> </a></li>
