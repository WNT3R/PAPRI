        ...
        <div class="container col-lg-9 col-sm-12 col-md-10 d-flex flex-lg-row flex-md-row flex-sm-column justify-content-between">
            <div class="d-flex justify-content-between col-lg-8 col-sm-12">
                <a class="navbar-brand" href="?">
                    <img src="assets/images/papri1.png" alt="" height="28">
 ...
 <a class="nav-link text-dark position-relative" id="show_not" data-bs-toggle="offcanvas" href="#notification_sidebar" role="button" aria-controls="offcanvasExample">
  ...
  <a class="nav-link text-dark" data-bs-toggle="offcanvas" href="#notification_sidebar" role="button" aria-controls="offcanvasExample"><i class="bi bi-bell-fill"></i></a>
    <?php
                   ...
                   <li class="nav-item">
                <a class="nav-link text-dark" href="assets/pages/mapping/index.php" role="button" aria-controls="modal fade"><i class="bi bi-geo-alt-fill"></a></i></li>
       
                <li class="nav-item">
                <a class="nav-link text-dark" href="assets/pages/shopping/cart.php" role="button" aria-controls="modal fade"><i class="bi bi-cart-check-fill"></a></i></li>
                ...
                <li class="nav-item dropdown dropstart">
                    ...
                    <li><a class="dropdown-item" href="?u=<?=$user['username']?>"><i class="bi bi-person"></i> My Profile</a></li>
                        ...
                        <li><a class="dropdown-item" href="assets/pages/terms.php"><i class="bi bi-gear"></i> Terms and Privacy</a></li>
                        <li><a class="dropdown-item" href="assets/pages/priv.php"><i class="bi bi-gear"></i>Privacy Policy</a></li>
                        <li><a class="dropdown-item" href="assets/pages/about.php"><i class="bi bi-file-person-fill"></i> About Us</a></li>
