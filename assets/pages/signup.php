        ...
        <div class="col-lg-4 col-md-8 col-sm-12 bg-white border rounded p-4 shadow-sm">
            <form method="post" action="assets/php/actions.php?signup">
                <div class="d-flex justify-content-center">
                    ...
                    <img class="mb-4" src="assets/images/papri1.png" alt="" height="45">
                </div>
                ...
                <div class="form-floating mt-1">
                    <input type="phone" name="phone" value="<?=showFormData('phone')?>" class="form-control rounded-0" placeholder="phone">
                ...
                <div class="form-floating mt-1">
                    <input type="text" name="address" value="<?=showFormData('address')?>" class="form-control rounded-0" placeholder="Address">
