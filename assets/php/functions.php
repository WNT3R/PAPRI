...
$response['status']=true;
    ...
    if(!$form_data['phone']){
        $response['msg']="Phone is not given";
        $response['status']=false;
    ...
    if(!$form_data['last_name']){
        $response['msg']="Lastname is not given";
        $response['status']=false;
        $response['field']='last_name';
    }
    if(!$form_data['first_name']){
        $response['msg']="Firstname is not given";
        $response['status']=false;
...
function createUser($data){
 ...
 $query = "INSERT INTO users(first_name,last_name,gender,email,phone,address,username,password) ";
 $query.="VALUES ('$first_name','$last_name',$gender,'$email','$phone','$address','$username','$password')"; 
 return mysqli_query($db,$query);
}
...
if($imagedata['name']){
    ...
    $profile_pic=", profile_pic='$image_name'";
        ...
        $query = "UPDATE users SET first_name = '$first_name', last_name='$last_name', phone = '$phone', address = '$address', username='$username',password='$password' $profile_pic WHERE id=".$_SESSION['userdata']['id'];
return mysqli_query($db,$query);
